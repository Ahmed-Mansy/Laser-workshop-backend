...
class DailyReportView(APIView):
    ...
    Manager only. Returns delivered orders and revenue for a specific date.
    ...
    def get(self, request):
        ...
        # Filter orders delivered on this date
...
class MonthlyReportView(APIView):
    ...
    Manager only. Returns delivered orders and revenue for a specific month.
    ...
    def get(self, request):
        ...
        return Response({
            ...
            'average_order_value': float(total_revenue / total_count) if total_count > 0 else 0
        })
